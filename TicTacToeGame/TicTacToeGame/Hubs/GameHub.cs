...
namespace TicTacToeGame
{
    ...
    public class GameHub : Hub
    {
        ...
        /// <returns></returns>
        public async Task OnOpponentDisconnected(string connectionId, string playerName)
        {
            //// Notify this connection id that the given player name has disconnected.
            return await Clients.Client(connectionId).InvokeAsync(Constants.OpponentDisconnected, playerName);
        }
